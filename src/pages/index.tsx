    ...
    <>
      ...
      <motion.div
            ...
            className="fade flex justify-center items-center flex-col h-full pb-20">
                ...
                <a href="https://drive.google.com/file/d/1dSiG6RkKXQSYgAwd1YBDl6MD36zvS_dX/view?usp=sharing" className="text-white p-2 bg-gradient-to-tl from-indigo-600 to-blue-500 rounded-md">Download Resume</a>
